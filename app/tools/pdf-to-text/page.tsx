...
export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-text");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-text" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-text" />
      <Faq items={getToolFaqs("pdf-to-text")} includeGeneral title={`${tool.name} — frequently asked questions`} />
