...
export const metadata: Metadata = buildToolMetadata("n-up");

export default function Page() {
  const jsonLd = buildToolJsonLd("n-up");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "n-up" },
        ]}
      />
      <Client />
      <RelatedTools slug="n-up" />
      <Faq items={getToolFaqs("n-up")} includeGeneral title={`${tool.name} — frequently asked questions`} />
