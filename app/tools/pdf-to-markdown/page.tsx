...
export const metadata: Metadata = buildToolMetadata("pdf-to-markdown");

export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-markdown");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-markdown" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-markdown" />
      <Faq items={getToolFaqs("pdf-to-markdown")} includeGeneral title={`${tool.name} — frequently asked questions`} />
