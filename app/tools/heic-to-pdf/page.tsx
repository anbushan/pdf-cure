...
export const metadata: Metadata = buildToolMetadata("heic-to-pdf");

export default function Page() {
  const jsonLd = buildToolJsonLd("heic-to-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "heic-to-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="heic-to-pdf" />
      <Faq items={getToolFaqs("heic-to-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
