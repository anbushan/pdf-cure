...
export const metadata: Metadata = buildToolMetadata("add-text");

export default function Page() {
  const jsonLd = buildToolJsonLd("add-text");
  ...
  return (
    <>
      ...
      />
      <Client />
      <RelatedTools slug="add-text" />
      <Faq items={getToolFaqs("add-text")} includeGeneral title={`${tool.name} — frequently asked questions`} />
