...
export default function Page() {
  const jsonLd = buildToolJsonLd("flatten-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "flatten-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="flatten-pdf" />
      <Faq items={getToolFaqs("flatten-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
