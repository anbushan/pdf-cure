...
export const metadata: Metadata = buildToolMetadata("add-image");

export default function Page() {
  const jsonLd = buildToolJsonLd("add-image");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "add-image" },
        ]}
      />
      <Client />
      <RelatedTools slug="add-image" />
      <Faq items={getToolFaqs("add-image")} includeGeneral title={`${tool.name} — frequently asked questions`} />
