...
export default function Page() {
  const jsonLd = buildToolJsonLd("remove-background");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "remove-background" },
        ]}
      />
      <Client />
      <RelatedTools slug="remove-background" />
      <Faq items={getToolFaqs("remove-background")} includeGeneral title={`${tool.name} — frequently asked questions`} />
