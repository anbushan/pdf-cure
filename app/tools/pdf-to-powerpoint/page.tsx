...
export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-powerpoint");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-powerpoint" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-powerpoint" />
      <Faq items={getToolFaqs("pdf-to-powerpoint")} includeGeneral title={`${tool.name} — frequently asked questions`} />
