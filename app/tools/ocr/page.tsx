...
export const metadata: Metadata = buildToolMetadata("ocr");

export default function Page() {
  const jsonLd = buildToolJsonLd("ocr");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "ocr" },
        ]}
      />
      <Client />
      <RelatedTools slug="ocr" />
      <Faq items={getToolFaqs("ocr")} includeGeneral title={`${tool.name} — frequently asked questions`} />
