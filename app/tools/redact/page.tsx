...
export const metadata: Metadata = buildToolMetadata("redact");

export default function Page() {
  const jsonLd = buildToolJsonLd("redact");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "redact" },
        ]}
      />
      <Client />
      <RelatedTools slug="redact" />
      <Faq items={getToolFaqs("redact")} includeGeneral title={`${tool.name} — frequently asked questions`} />
