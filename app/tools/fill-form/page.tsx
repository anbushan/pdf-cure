...
export const metadata: Metadata = buildToolMetadata("fill-form");

export default function Page() {
  const jsonLd = buildToolJsonLd("fill-form");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "fill-form" },
        ]}
      />
      <Client />
      <RelatedTools slug="fill-form" />
      <Faq items={getToolFaqs("fill-form")} includeGeneral title={`${tool.name} — frequently asked questions`} />
