...
export const metadata: Metadata = buildToolMetadata("batch");

export default function Page() {
  const jsonLd = buildToolJsonLd("batch");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "batch" },
        ]}
      />
      <Client />
      <RelatedTools slug="batch" />
      <Faq items={getToolFaqs("batch")} includeGeneral title={`${tool.name} — frequently asked questions`} />
