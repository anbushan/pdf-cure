...
export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-word");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-word" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-word" />
      <Faq items={getToolFaqs("pdf-to-word")} includeGeneral title={`${tool.name} — frequently asked questions`} />
