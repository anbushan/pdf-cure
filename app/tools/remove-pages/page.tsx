...
export default function Page() {
  const jsonLd = buildToolJsonLd("remove-pages");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "remove-pages" },
        ]}
      />
      <Client />
      <RelatedTools slug="remove-pages" />
      <Faq items={getToolFaqs("remove-pages")} includeGeneral title={`${tool.name} — frequently asked questions`} />
