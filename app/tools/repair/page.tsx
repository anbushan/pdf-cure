...
export const metadata: Metadata = buildToolMetadata("repair");

export default function Page() {
  const jsonLd = buildToolJsonLd("repair");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "repair" },
        ]}
      />
      <Client />
      <RelatedTools slug="repair" />
      <Faq items={getToolFaqs("repair")} includeGeneral title={`${tool.name} — frequently asked questions`} />
