...
export const metadata: Metadata = buildToolMetadata("sign");

export default function Page() {
  const jsonLd = buildToolJsonLd("sign");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "sign" },
        ]}
      />
      <Client />
      <RelatedTools slug="sign" />
      <Faq items={getToolFaqs("sign")} includeGeneral title={`${tool.name} — frequently asked questions`} />
