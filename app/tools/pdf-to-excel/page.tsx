...
export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-excel");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-excel" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-excel" />
      <Faq items={getToolFaqs("pdf-to-excel")} includeGeneral title={`${tool.name} — frequently asked questions`} />
