...
export const metadata: Metadata = buildToolMetadata("resize-pdf");

export default function Page() {
  const jsonLd = buildToolJsonLd("resize-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "resize-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="resize-pdf" />
      <Faq items={getToolFaqs("resize-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
