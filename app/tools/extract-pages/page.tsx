...
export const metadata: Metadata = buildToolMetadata("extract-pages");

export default function Page() {
  const jsonLd = buildToolJsonLd("extract-pages");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "extract-pages" },
        ]}
      />
      <Client />
      <RelatedTools slug="extract-pages" />
      <Faq items={getToolFaqs("extract-pages")} includeGeneral title={`${tool.name} — frequently asked questions`} />
