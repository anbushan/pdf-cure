...
export default function Page() {
  const jsonLd = buildToolJsonLd("merge");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "merge" },
        ]}
      />
      <Client />
      <RelatedTools slug="merge" />
      <Faq items={getToolFaqs("merge")} includeGeneral title={`${tool.name} — frequently asked questions`} />
