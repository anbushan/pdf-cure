...
export const metadata: Metadata = buildToolMetadata("read-aloud");

export default function Page() {
  const jsonLd = buildToolJsonLd("read-aloud");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "read-aloud" },
        ]}
      />
      <Client />
      <RelatedTools slug="read-aloud" />
      <Faq items={getToolFaqs("read-aloud")} includeGeneral title={`${tool.name} — frequently asked questions`} />
