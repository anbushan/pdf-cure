...
export const metadata: Metadata = buildToolMetadata("bank-statement-to-excel");

export default function Page() {
  const jsonLd = buildToolJsonLd("bank-statement-to-excel");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "bank-statement-to-excel" },
        ]}
      />
      <Client />
      <RelatedTools slug="bank-statement-to-excel" />
      <Faq items={getToolFaqs("bank-statement-to-excel")} includeGeneral title={`${tool.name} — frequently asked questions`} />
