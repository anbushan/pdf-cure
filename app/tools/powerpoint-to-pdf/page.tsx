...
export default function Page() {
  const jsonLd = buildToolJsonLd("powerpoint-to-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "powerpoint-to-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="powerpoint-to-pdf" />
      <Faq items={getToolFaqs("powerpoint-to-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
