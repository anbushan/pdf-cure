...
export default function Page() {
  const jsonLd = buildToolJsonLd("pdf-to-jpg");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "pdf-to-jpg" },
        ]}
      />
      <Client />
      <RelatedTools slug="pdf-to-jpg" />
      <Faq items={getToolFaqs("pdf-to-jpg")} includeGeneral title={`${tool.name} — frequently asked questions`} />
