...
export const metadata: Metadata = buildToolMetadata("extract-images");

export default function Page() {
  const jsonLd = buildToolJsonLd("extract-images");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "extract-images" },
        ]}
      />
      <Client />
      <RelatedTools slug="extract-images" />
      <Faq items={getToolFaqs("extract-images")} includeGeneral title={`${tool.name} — frequently asked questions`} />
