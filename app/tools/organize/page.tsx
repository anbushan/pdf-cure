...
export const metadata: Metadata = buildToolMetadata("organize");

export default function Page() {
  const jsonLd = buildToolJsonLd("organize");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "organize" },
        ]}
      />
      <Client />
      <RelatedTools slug="organize" />
      <Faq items={getToolFaqs("organize")} includeGeneral title={`${tool.name} — frequently asked questions`} />
