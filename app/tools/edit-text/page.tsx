...
export const metadata: Metadata = buildToolMetadata("edit-text");

export default function Page() {
  const jsonLd = buildToolJsonLd("edit-text");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "edit-text" },
        ]}
      />
      <Client />
      <RelatedTools slug="edit-text" />
      <Faq items={getToolFaqs("edit-text")} includeGeneral title={`${tool.name} — frequently asked questions`} />
