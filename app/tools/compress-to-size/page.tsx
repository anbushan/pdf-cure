...
export const metadata: Metadata = buildToolMetadata("compress-to-size");

export default function Page() {
  const jsonLd = buildToolJsonLd("compress-to-size");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "compress-to-size" },
        ]}
      />
      <Client />
      <RelatedTools slug="compress-to-size" />
      <Faq items={getToolFaqs("compress-to-size")} includeGeneral title={`${tool.name} — frequently asked questions`} />
