...
export default function Page() {
  const jsonLd = buildToolJsonLd("scan-to-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "scan-to-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="scan-to-pdf" />
      <Faq items={getToolFaqs("scan-to-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
