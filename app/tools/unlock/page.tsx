...
export const metadata: Metadata = buildToolMetadata("unlock");

export default function Page() {
  const jsonLd = buildToolJsonLd("unlock");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "unlock" },
        ]}
      />
      <Client />
      <RelatedTools slug="unlock" />
      <Faq items={getToolFaqs("unlock")} includeGeneral title={`${tool.name} — frequently asked questions`} />
