...
export const metadata: Metadata = buildToolMetadata("detect-plagiarism");

export default function Page() {
  const jsonLd = buildToolJsonLd("detect-plagiarism");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "detect-plagiarism" },
        ]}
      />
      <AiGate tool={tool}>
        <Client />
      </AiGate>
      <RelatedTools slug="detect-plagiarism" />
      <Faq items={getToolFaqs("detect-plagiarism")} includeGeneral title={`${tool.name} — frequently asked questions`} />
