...
export const metadata: Metadata = buildToolMetadata("protect");

export default function Page() {
  const jsonLd = buildToolJsonLd("protect");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "protect" },
        ]}
      />
      <Client />
      <RelatedTools slug="protect" />
      <Faq items={getToolFaqs("protect")} includeGeneral title={`${tool.name} — frequently asked questions`} />
