...
export const metadata: Metadata = buildToolMetadata("bates-numbering");

export default function Page() {
  const jsonLd = buildToolJsonLd("bates-numbering");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "bates-numbering" },
        ]}
      />
      <Client />
      <RelatedTools slug="bates-numbering" />
      <Faq items={getToolFaqs("bates-numbering")} includeGeneral title={`${tool.name} — frequently asked questions`} />
