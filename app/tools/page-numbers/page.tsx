...
export default function Page() {
  const jsonLd = buildToolJsonLd("page-numbers");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "page-numbers" },
        ]}
      />
      <Client />
      <RelatedTools slug="page-numbers" />
      <Faq items={getToolFaqs("page-numbers")} includeGeneral title={`${tool.name} — frequently asked questions`} />
