...
export default function Page() {
  const jsonLd = buildToolJsonLd("excel-to-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "excel-to-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="excel-to-pdf" />
      <Faq items={getToolFaqs("excel-to-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
