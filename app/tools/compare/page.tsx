...
export const metadata: Metadata = buildToolMetadata("compare");

export default function Page() {
  const jsonLd = buildToolJsonLd("compare");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "compare" },
        ]}
      />
      <Client />
      <RelatedTools slug="compare" />
      <Faq items={getToolFaqs("compare")} includeGeneral title={`${tool.name} — frequently asked questions`} />
