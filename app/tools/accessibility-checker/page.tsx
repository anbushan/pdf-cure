...
export const metadata: Metadata = buildToolMetadata("accessibility-checker");

export default function Page() {
  const jsonLd = buildToolJsonLd("accessibility-checker");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "accessibility-checker" },
        ]}
      />
      <Client />
      <RelatedTools slug="accessibility-checker" />
      <Faq items={getToolFaqs("accessibility-checker")} includeGeneral title={`${tool.name} — frequently asked questions`} />
