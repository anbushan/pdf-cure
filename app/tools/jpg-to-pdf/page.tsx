...
export default function Page() {
  const jsonLd = buildToolJsonLd("jpg-to-pdf");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "jpg-to-pdf" },
        ]}
      />
      <Client />
      <RelatedTools slug="jpg-to-pdf" />
      <Faq items={getToolFaqs("jpg-to-pdf")} includeGeneral title={`${tool.name} — frequently asked questions`} />
