...
export default function Page() {
  const jsonLd = buildToolJsonLd("crop");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "crop" },
        ]}
      />
      <Client />
      <RelatedTools slug="crop" />
      <Faq items={getToolFaqs("crop")} includeGeneral title={`${tool.name} — frequently asked questions`} />
