...
export const metadata: Metadata = buildToolMetadata("add-qrcode");

export default function Page() {
  const jsonLd = buildToolJsonLd("add-qrcode");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "add-qrcode" },
        ]}
      />
      <Client />
      <RelatedTools slug="add-qrcode" />
      <Faq items={getToolFaqs("add-qrcode")} includeGeneral title={`${tool.name} — frequently asked questions`} />
