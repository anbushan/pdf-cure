...
export default function Page() {
  const jsonLd = buildToolJsonLd("split");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "split" },
        ]}
      />
      <Client />
      <RelatedTools slug="split" />
      <Faq items={getToolFaqs("split")} includeGeneral title={`${tool.name} — frequently asked questions`} />
