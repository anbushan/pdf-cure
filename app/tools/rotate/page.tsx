...
export default function Page() {
  const jsonLd = buildToolJsonLd("rotate");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "rotate" },
        ]}
      />
      <Client />
      <RelatedTools slug="rotate" />
      <Faq items={getToolFaqs("rotate")} includeGeneral title={`${tool.name} — frequently asked questions`} />
