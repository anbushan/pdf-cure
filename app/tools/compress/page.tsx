...
export default function Page() {
  const jsonLd = buildToolJsonLd("compress");
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: tool.name, toolSlug: "compress" },
        ]}
      />
      <Client />
      <RelatedTools slug="compress" />
      <Faq items={getToolFaqs("compress")} includeGeneral title={`${tool.name} — frequently asked questions`} />
